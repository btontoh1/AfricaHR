...
describe('summarizePayrollCosts', () => {
  ...
  it('sums gross, net, deductions, and employer cost within a single currency', () => {
    const result = summarizePayrollCosts([
      { currency: 'GHS', grossPay: 3000, netPay: 2400, totalDeductions: 600, ssnitEmployer: 390, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
      { currency: 'GHS', grossPay: 5000, netPay: 3900, totalDeductions: 1100, ssnitEmployer: 650, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
    ]);
  ...
  it('keeps different currencies in separate totals instead of blending them together', () => {
    const result = summarizePayrollCosts([
      { currency: 'GHS', grossPay: 3000, netPay: 2400, totalDeductions: 600, ssnitEmployer: 390, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
      { currency: 'NGN', grossPay: 100_000, netPay: 91_200, totalDeductions: 8800, ssnitEmployer: 10_000, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
      { currency: 'GHS', grossPay: 5000, netPay: 3900, totalDeductions: 1100, ssnitEmployer: 650, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
    ]);
  ...
  it('orders currency groups alphabetically regardless of input order', () => {
    const result = summarizePayrollCosts([
      { currency: 'NGN', grossPay: 1, netPay: 1, totalDeductions: 0, ssnitEmployer: 0, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
      { currency: 'GHS', grossPay: 1, netPay: 1, totalDeductions: 0, ssnitEmployer: 0, ghanaTier2PensionEmployer: 0, kenyaHousingLevyEmployer: 0, nigeriaNsitfEmployer: 0, nigeriaNhisEmployer: 0 },
    ]);
