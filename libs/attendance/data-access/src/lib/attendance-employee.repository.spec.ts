...
describe('AttendanceEmployeeRepository', () => {
  let repository: AttendanceEmployeeRepository;
  ...
  beforeEach(() => {
    ...
    repository = new AttendanceEmployeeRepository(prisma as unknown as PrismaService);
  });
