...
import { useUpdateTenantUserProfile } from './queries';
import { updateUserProfileFormSchema, type UpdateUserProfileFormValues } from '@/features/iam/team-members-form-schema';
...
export function EditTenantUserProfileDialog({ tenantId, user }: { tenantId: string; user: User }) {
  const [open, setOpen] = useState(false);
  const updateProfile = useUpdateTenantUserProfile(tenantId);
