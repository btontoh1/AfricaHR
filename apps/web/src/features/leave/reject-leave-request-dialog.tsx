...
import { useRejectLeaveRequest } from './queries';
import {
...
export function RejectLeaveRequestDialog({ tenantId, id }: { tenantId: string; id: string }) {
  const [open, setOpen] = useState(false);
  const rejectRequest = useRejectLeaveRequest(tenantId);
