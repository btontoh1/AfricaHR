...
import { useAdminResetTenantUserPassword } from './queries';
import { resetUserPasswordFormSchema, type ResetUserPasswordFormValues } from '@/features/iam/team-members-form-schema';
...
export function ResetTenantUserPasswordDialog({ tenantId, user }: { tenantId: string; user: User }) {
  const [open, setOpen] = useState(false);
  const resetPassword = useAdminResetTenantUserPassword(tenantId);
